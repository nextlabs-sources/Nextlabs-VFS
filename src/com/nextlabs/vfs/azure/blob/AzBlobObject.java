 ...
 */
public class AzBlobObject extends AbstractFileObject {
	private static final Logger log = LogManager.getLogger(AzBlobObject.class);

	private final AzBlobSystem fileSystem;
	...
	/**
	 * Creates a new FileObject for use with a remote Azure Blob Storage file or
	 * folder.
	 * 
	 * @param name
	 * @param fileSystem
	 */
	protected AzBlobObject(final AbstractFileName name, final AzBlobSystem fileSystem) {
...
//    }
	...
	/**
	 * Used for creating folders. It's not used since Azure Cloud Storage does not
	...
	/**
	 * Callback for getting an OutputStream for writing into Azure Blob Storage
	 * file.
	 * 
