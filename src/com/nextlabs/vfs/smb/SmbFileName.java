...
public class SmbFileName extends GenericFileName {
	...
	protected SmbFileName(final String scheme, final String hostName, final int port, final String userName, final String password, final String domain, final String share, final String path, final FileType type) {
	...
	public FileName createName(final String path, final FileType type) {
		return new SmbFileName("file", getHostName(), getPort(), getUserName(), getPassword(), domain, share, path, type);
	}
